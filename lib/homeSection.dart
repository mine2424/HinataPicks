                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: bottomIcons == BottomIcons.Blog ? Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 8,),
                                Text('blog',style: TextStyle(color: Colors.indigo,fontWeight: FontWeight.bold,fontSize: 15))
                                ],
                            ),
                          ):Icon(Icons.book)
                        ),
                        GestureDetector(
                          ...
                          child: bottomIcons == BottomIcons.Video ? Container(
                            decoration: BoxDecoration(
                              color: Colors.indigo.shade100.withOpacity(0.6),
                              borderRadius: BorderRadius.circular(30)
                            ),
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.video_library,color: Colors.indigo,),
                                SizedBox(width: 8,),
                                Text('Video',style: TextStyle(color: Colors.indigo,fontWeight: FontWeight.bold,fontSize: 15))
                                ],
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: bottomIcons == BottomIcons.Archive ? Container(
                            decoration: BoxDecoration(
                              color: Colors.indigo.shade100.withOpacity(0.6),
                              borderRadius: BorderRadius.circular(30)
                            ),
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 8,),
                                Text('Archive',style: TextStyle(color: Colors.indigo,fontWeight: FontWeight.bold,fontSize: 15))
                                ],
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: bottomIcons == BottomIcons.Other ? Container(
                            decoration: BoxDecoration(
                              color: Colors.indigo.shade100.withOpacity(0.6),
                              borderRadius: BorderRadius.circular(30)
                            ),
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 8,),
                                Text('Other',style: TextStyle(color: Colors.indigo,fontWeight: FontWeight.bold,fontSize: 15))
                                ],
                            ),
                          ):Icon(Icons.settings)
                        ),
